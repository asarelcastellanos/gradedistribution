...
export default function CourseCard({ course }) {
  ...
  let passRate = (((course.A + course.B + course.C + course.P) / course.Grand_Total)*100).toFixed(2);

  return (
    <div className="flex flex-col md:flex-row flex-grow mb-10">
      <div className="md:w-1/5 w-full h-full p-4">
      ...
      <div className="md:w-4/5 w-full h-full p-4">
